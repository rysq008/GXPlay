...
public class SocketClient extends WebSocketClient {
     ...
     */
    private static final String mAddress = "ws://192.168.1.19/ws?id=10";//"ws://服务器地址：端口/mhwang7758/websocket/";
    ...
    public static void initWebSocket(final Context context, final long vmc_no) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mWebClient = new SocketClient(new URI(mAddress + vmc_no), context);
                    try {
