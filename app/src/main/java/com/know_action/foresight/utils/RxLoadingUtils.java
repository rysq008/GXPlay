...
import com.know_action.foresight.event.RxBusProvider;
import com.know_action.foresight.event.RxMsgEvent;
import com.know_action.foresight.views.XReloadableRecyclerContentLayout;
import com.know_action.foresight.views.XReloadableStateContorller;
...
public class RxLoadingUtils {
    public static <T> void subscribeWithReloadTwo(final XReloadableRecyclerContentLayout reloadableFrameLayout,
    ...
    public static <T extends IModel> void subscribeWithReloadTwo(final XReloadableRecyclerContentLayout reloadableLayout,
                                                                 final Flowable<T> Flowable, final FlowableTransformer transformer, final Consumer<T> onNext, final Consumer<NetError> onError,
                                                                 final Action onComplete, final boolean showLoading) {
    ...
    public static <T> void subscribeWithReloadTwo(final XReloadableRecyclerContentLayout reloadableLayout,
