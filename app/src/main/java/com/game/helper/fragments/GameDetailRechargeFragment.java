...
public class GameDetailRechargeFragment extends XBaseFragment {
    ...
    @BindView(R.id.tv_account_game_detail_recharge)
    TextView mAccount;
    @BindView(R.id.ll_account_game_detail_recharge)
    LinearLayout mItemAccount;
    @BindView(R.id.et_balance_game_detail_recharge)
    EditText mEtBalance;
    @BindView(R.id.ll_balance_game_detail_recharge)
    LinearLayout llBalance;
    @BindView(R.id.tv_memmber_vip_level_game_detail_recharge)
    TextView tvUserVipLevel;
    @BindView(R.id.tv_game_account_type_game_detail_recharge)
    TextView tvGameAccountType;
    @BindView(R.id.tv_upgrade_vip_alert_game_detail_recharge)
    TextView mTvUpgradeVipAlert;
    @BindView(R.id.rb_vip0_game_detail_recharge)
    RadioButton rbVip0;
    @BindView(R.id.rb_vip1_game_detail_recharge)
    RadioButton rbVip1;
    @BindView(R.id.rb_vip2_game_detail_recharge)
    RadioButton rbVip2;
    @BindView(R.id.rb_vip3_game_detail_recharge)
    RadioButton rbVip3;
    @BindView(R.id.rg_vip_game_detail_recharge)
    RadioGroup rgVip;
    @BindView(R.id.tv_total_discount_game_detail_recharge)
    TextView mTotalDiscount;
    @BindView(R.id.tv_total_balance_game_detail_recharge)
    TextView mTotalBalance;
    @BindView(R.id.pb_game_detail_recharge)
    ProgressBar pbVip;
    @BindView(R.id.tv_upgrade_vip_name_game_detail_recharge)
    TextView mTvUpgradeVipName;
    @BindView(R.id.tv_upgrade_vip_discount_game_detail_recharge)
    TextView mTvUpgradeVipDiscount;
    @BindView(R.id.ll_upgrade_vip_game_detail_recharge)
    ...
    private void initIntent() {
        if (getArguments() != null) {
            gameDetailInfo = (GamePackageInfoResult) getArguments().getSerializable(GameDetailFragment.GAME_DETAIL_INFO);
        }
    }
    ...
    @OnClick({R.id.ll_account_game_detail_recharge, R.id.et_balance_game_detail_recharge, R.id.rb_vip0_game_detail_recharge
            , R.id.rb_vip1_game_detail_recharge, R.id.rb_vip2_game_detail_recharge, R.id.rb_vip3_game_detail_recharge
            , R.id.ll_connect_kefu_recharge_game_detail, R.id.tv_confirm_order_recharge_game_detail})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.ll_account_game_detail_recharge:
                ...
                break;
            case R.id.et_balance_game_detail_recharge:
                ...
                break;
            case R.id.rb_vip0_game_detail_recharge:
                level = 0;
                onClickChanged(level, view, rbVip0.isChecked());
                break;
            case R.id.rb_vip1_game_detail_recharge:
                /*if (rbVip1.isChecked()) {
                    showPopWindow(view);
                }*/
                level = 1;
                ...
                break;
            case R.id.rb_vip2_game_detail_recharge:
                /*if (rbVip2.isChecked()) {
                    showPopWindow(view);
                }*/
                level = 2;
                ...
                break;
            case R.id.rb_vip3_game_detail_recharge:
                /*if (rbVip3.isChecked()) {
                    showPopWindow(view);
                }*/
                level = 3;
    ...
    private void confirmOrder() {
        ...
        } else if (getIsGoToVip()) {
            ToastUtil.showToast("请升级会员");
        } else if (getGameVipAccountNotEnough()) {
