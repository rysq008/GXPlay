 ...
 *
 */
public class GameItemAdapter extends SimpleRecAdapter<ItemType, GameItemAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDisplay(ItemType itemType) {
            recommondLayout.setData((RecommendResults.RecommendItem) itemType);
