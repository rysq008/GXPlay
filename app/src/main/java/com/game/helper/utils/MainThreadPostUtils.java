...
public class MainThreadPostUtils {
            ...
            if (handler == null) {
                handler = new Handler(Looper.getMainLooper()) {
                    ...
                    public void handleMessage(Message msg) {
                        switch (msg.what) {
                            case MESSAGE_TOAST:
                                TotoroToast.makeText(GameMarketApplication.getContext(), msg.obj.toString(),
    ...
    public static void toast(int res) {
        String msg = GameMarketApplication.getContext().getString(res);
        toast(msg);
    }
    ...
    private static void checkContext() {
        if (GameMarketApplication.getContext() == null) {
