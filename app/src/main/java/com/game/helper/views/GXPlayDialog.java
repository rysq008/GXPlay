...
public class GXPlayDialog extends android.support.v4.app.DialogFragment implements View.OnClickListener {
    public static final String TAG = GXPlayDialog.class.getSimpleName();
    ...
    @SuppressLint("ValidFragment")
    public GXPlayDialog(int type, @Nullable String tittle, @Nullable String content) {
        this.type = type;
