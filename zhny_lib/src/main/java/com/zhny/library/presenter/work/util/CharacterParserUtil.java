...
public class CharacterParserUtil {
    ...
    private static final String TAG = "CharacterParserUtil";

    private static String[] PY_STR = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    private static int[] PY_VALUE = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            Log.d(TAG, "ERROR:ChineseSpelling.class-getChsAscii(String chs)" + e);
        }
        return asc;
    }
