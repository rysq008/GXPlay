package com.zhny.library.presenter.work.custom.wheelview;
...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    private Paint mPaint, mActuralPaint;
    ...
    private int mItemSelectTextSize;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemSelectTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_select_text_size, 22);
        ...
        mActuralPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG | Paint.LINEAR_TEXT_FLAG);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                mActuralPaint.setColor(getSelectedItemTextColor());
                mActuralPaint.setTextSize(mItemSelectTextSize);
                mActuralPaint.setTextAlign(Paint.Align.CENTER);
                canvas.drawText(data, mDrawnCenterX, drawnCenterY+centerX, mActuralPaint);
                canvas.restore();
            } else {
                canvas.save();
     ...
     * @param offset
     */
    public void updateOffsetCenterY(int offset){
        this.centerX = offset;
        invalidate();
    }
